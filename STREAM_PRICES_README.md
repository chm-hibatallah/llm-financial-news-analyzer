...
**Example Output:**
```
🚀 Starting price stream (updating every 60s)
📁 Cache: data/cache/intraday_prices.json

[1] 2026-04-07 12:30:00 — Fetching prices...
✓ AAPL: 187 intraday candles
✓ TSLA: 185 intraday candles  
✓ MSFT: 189 intraday candles
